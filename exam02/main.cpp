...
void logger() {
   ...
   while (t_10s.read() <= 10.5) {
    ...
    float horizontal_displacement = 1/2 * (9.8 * sqrt((r[0]-t[0])*(r[0]-t[0])+(r[1]-t[1])*(r[1]-t[1])) ) * (0.1*0.1); 

    if(horizontal_displacement >= 5){
        //greenLED = 0;
        pc.printf("%f\r\n%f\r\n%f\r\n%f\r\n%d\r\n", r[0], r[1], r[2], horizontal_displacement, 1);
    }else{
        //greenLED = 1;
        pc.printf("%f\r\n%f\r\n%f\r\n%f\r\n%d\r\n", r[0], r[1], r[2], horizontal_displacement, 0);
    }
